...
export default function Wisata() {
  const [hero, setHero] = useState({
    title: 'Wisata Pemancingan Latar Bale',
    subtitle:
  ...
  useEffect(() => {
    async function loadHero() {
      try {
        ...
        console.error('Gagal mengambil pengaturan hero wisata:', error);
      }
    }
  ...
  const handleOpenMaps = () => {
    window.open(
      'https://maps.app.goo.gl/vdV1Zf2wcCa4gMKk6',
      '_blank'
    );
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          ...
          <div className="md:col-span-1 md:row-span-2 group relative overflow-hidden rounded-xl bg-surface-container border border-outline-variant/20 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col justify-end bg-surface-container z-10 relative -mt-4">
              ...
              <h3 className="font-heading font-bold text-headline-md text-on-surface mb-3">
                Spesies Ikan
              </h3>

              <p className="font-sans text-body-md text-on-surface-variant leading-relaxed">
                Kolam kami dikelola dengan standar akuakultur tinggi,
                menyediakan habitat ideal bagi ikan <strong>Lele</strong> dan{' '}
                <strong>Nila</strong> premium. Nikmati sensasi tarikan ikan
                yang sehat dalam lingkungan yang terjaga kualitas airnya.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-surface-container rounded-xl border border-outline-variant/20 shadow-sm hover:shadow-md transition-all duration-300 p-6 md:p-8 flex flex-col md:flex-row items-center gap-8 group">
            <div className="flex-1">
              ...
              <p className="font-sans text-body-md text-on-surface-variant leading-relaxed">
                Kami menerapkan sistem sewa per jam yang fleksibel dipadukan
                dengan manajemen tangkapan berkelanjutan. Pendekatan ini
                memastikan populasi kolam tetap sehat dan setiap pengunjung
                mendapatkan pengalaman memancing yang optimal.
              </p>
            </div>
          ...
          <div className="md:col-span-2 bg-secondary-container text-on-secondary-container rounded-xl p-6 md:p-8 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-center">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="font-heading font-bold text-headline-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-2">
              <div>
                <h4 className="font-label-md text-label-md mb-1 opacity-80 uppercase tracking-wider">
                  Waktu Terbaik
                </h4>
              ...
              <div>
                ...
                <p className="font-sans text-body-md leading-relaxed">
                  Gazebo Pribadi, Kantin Desa, Area Bersih, Toilet &amp;
                  Mushola.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-heading font-bold text-headline-md text-on-surface mb-2 text-xl">
                Jaga Kebersihan
              </h4>

              <p className="font-sans text-body-md text-on-surface-variant text-center leading-relaxed">
                Dilarang membuang sampah sembarangan. Tersedia tempat sampah
                terpilah di setiap area gazebo.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-sans text-body-md text-on-surface-variant text-center leading-relaxed">
                Tersedia pilihan <em>Catch &amp; Release</em> untuk
                kelestarian, atau timbang bayar untuk ikan yang dibawa pulang.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-sans text-body-md text-on-surface-variant text-center leading-relaxed">
                Gunakan umpan alami yang disediakan atau disetujui pihak
                pengelola untuk menjaga kualitas air kolam.
              </p>
            </div>
        ...
        <div className="bg-surface-container rounded-2xl overflow-hidden shadow-sm border border-outline-variant/30 flex flex-col md:flex-row">
          ...
          <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
            ...
            <p className="font-sans text-body-md text-on-surface-variant mb-8 leading-relaxed">
              Latar Bale Fishing Tourism berlokasi strategis di pusat Desa
              Mulyoarjo. Tempat pelarian sempurna dari hiruk-pikuk kota, mudah
              diakses kendaraan pribadi.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-sans text-body-md text-on-surface">
                  Paras, Mulyoarjo, Kec. Lawang, Kabupaten Malang, Jawa Timur 65216
                </span>
              </div>

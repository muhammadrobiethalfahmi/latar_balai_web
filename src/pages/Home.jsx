...
export default function Home() {
  const [hero, setHero] = useState({
    badge: 'Selamat Datang di Mulyoarjo',
    title: 'Latar Bale Mulyoarjo',
     subtitle:
    ...
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuCuAyNRnLLU1FG7adbhii-1lB-tNaQhJdx1fjnacghF1VpZujhVMccMJbZ_Kx4VlNwpOSSj1GJyRwbQmC7yFeMmr58MO0Ghjuxyn_A9671YBifJLg0dab9HbrQ8YF41tavQPA6maUF8ZfM9BCqoR7lwMWjed6LdeOP4zqfjzzsz8DHlfQ4A8ba6-P0kc4VjSXKp5Oon-JC9Za6Xr_thvCGXpUou1UCCeeiXjPC-054WpmcOIjiMrNio1e4oGl9W9EgZInk74IMuVtOD',
  });
  ...
  useEffect(() => {
    async function loadHero() {
      try {
        ...
        console.error('Gagal mengambil pengaturan hero:', error);
      }
    }
    ...
    <main className="w-full text-left bg-[#FCFBF7]">
      ...
      <section className="relative w-full min-h-[650px] md:h-[85vh] flex items-center justify-center overflow-hidden bg-emerald-950">
        <div className="absolute inset-0 w-full h-full">
          <div
            className="bg-cover bg-center w-full h-full opacity-100 mix-blend-overlay"
            style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/5] sm:aspect-video lg:aspect-[4/5]">
              <img
                ...
                src="https://res.cloudinary.com/zqov2yh8/image/upload/v1785646949/Biru_dan_Coklat_Ilustrasi_Lomba_Mancing_Konten_Instagram_45_vuh9d5.jpg"
              />
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h2 className="font-serif font-bold text-3xl md:text-4xl text-stone-800 mb-6 leading-tight">
              Merawat Tradisi, <br />
              <span className="text-emerald-700">Membangun Potensi</span>
            </h2>

            <p className="font-sans text-base md:text-lg text-stone-600 mb-6 leading-relaxed">
              Latar Bale Mulyoarjo bukan sekadar pusat administrasi, melainkan
              jantung denyut nadi ekonomi dan budaya desa kami. Kami percaya
              bahwa setiap jengkal tanah dan setiap individu di desa ini
              memiliki potensi luar biasa yang siap untuk dikembangkan.
            </p>

            <p className="font-sans text-sm md:text-base text-stone-500 mb-8 leading-relaxed">
              Melalui integrasi program edukasi agrikultur, pengelolaan wisata
              alam yang berkelanjutan, dan pemberdayaan produk lokal melalui
              e-commerce desa, kami mewujudkan visi Mulyoarjo sebagai desa
              mandiri yang sejahtera dan berdaya saing tinggi di era digital.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 w-full pt-4 border-t border-stone-200">
              ...
              <div>
                <span className="block font-serif font-bold text-3xl md:text-4xl text-emerald-600 mb-1">
                  100%
                </span>

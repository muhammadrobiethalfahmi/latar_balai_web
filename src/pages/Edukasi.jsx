...
export default function Edukasi() {
  const [hero, setHero] = useState({
    title: 'Belajar Budidaya Kambing Bersama Latar Bale Mulyoarjo',
    subtitle:
      'Pusat pembelajaran komunitas untuk peternakan berkelanjutan dan pemberdayaan ekonomi desa.',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDfjnITj_CRZK9kfTfgleQJwpg8WDkiYLNxT3txAlAt94nmJP0Shhktvii4vH9P5c8yKBPDKXKhNYjsn3IZO3BTZ5afPyDnBjhzuCf3op5Wo9txQKz8oe48Tm2WtAru4aoHPjYb03ObWe1JrYln8TsSoTwCjzJuoYb58mxH5JXOxwMhn_vL3qzkzkGd5tA3G45cyAwiFbhkmfAmnagwzZLFHNY6bD39tZEJKur5GvMJHP4Uz_yK_JvKnRo6p54XWUywmBYrCGOnuOAO',
  });
  ...
  useEffect(() => {
    async function loadHero() {
      try {
        ...
        console.error(
          'Gagal mengambil pengaturan hero edukasi:',
          error
        );
      }
    }
    ...
    <main className="w-full text-left bg-[#FCFBF7]">
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Image */}
          <div className="lg:col-span-5 relative pb-6 md:pb-0">
            ...
            <div className="absolute -bottom-4 -right-4 bg-white p-5 rounded-2xl shadow-xl border border-stone-100 hidden md:block">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans font-bold text-2xl text-emerald-800 leading-none">
                    50+
                  </p>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="font-sans text-base text-stone-600 leading-relaxed">
              Program Edukasi Budidaya Kambing di Latar Bale Mulyoarjo
              didedikasikan untuk menjembatani kearifan lokal dengan
              inovasi peternakan modern. Kami percaya bahwa pengetahuan
              adalah kunci utama dalam membangun ekosistem desa yang
              tangguh dan mandiri.
            </p>

            <p className="font-sans text-base text-stone-600 leading-relaxed">
              Melalui pendekatan praktis dan berbasis komunitas,
              pengunjung dan warga desa diajak untuk memahami setiap
              aspek siklus kehidupan ternak—mulai dari manajemen nutrisi
              hingga perawatan holistik—menjadikan peternakan sebagai
              sumber kebanggaan dan kesejahteraan bersama.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="font-sans text-base text-stone-600 max-w-2xl mx-auto leading-relaxed">
              Metodologi edukasi kami dirancang secara bertahap untuk
              memastikan pemahaman mendalam pada setiap fase peternakan.
            </p>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 relative z-10">
              ...
              <div className="flex flex-col items-center text-center group bg-white lg:bg-transparent p-6 lg:p-0 rounded-2xl shadow-sm lg:shadow-none border border-stone-100 lg:border-none">
                ...
                <h3 className="font-sans font-bold text-xl text-stone-800 mb-3">
                  Persiapan
                </h3>

                <p className="font-sans text-sm text-stone-600 leading-relaxed max-w-xs">
                  Pemahaman desain kandang ideal, sanitasi lingkungan,
                  dan persiapan lahan hijau untuk kesejahteraan ternak.
                </p>
              ...
              <div className="flex flex-col items-center text-center group bg-white lg:bg-transparent p-6 lg:p-0 rounded-2xl shadow-sm lg:shadow-none border border-stone-100 lg:border-none">
                ...
                <p className="font-sans text-sm text-stone-600 leading-relaxed max-w-xs">
                  Edukasi formulasi nutrisi, pengenalan hijauan unggul,
                  dan teknik fermentasi pakan alami yang berkelanjutan.
                </p>
              ...
              <div className="flex flex-col items-center text-center group bg-white lg:bg-transparent p-6 lg:p-0 rounded-2xl shadow-sm lg:shadow-none border border-stone-100 lg:border-none">
                ...
                <p className="font-sans text-sm text-stone-600 leading-relaxed max-w-xs">
                  Praktik perawatan harian, menjaga kebersihan ternak,
                  dan pendekatan ramah hewan untuk meminimalisir stres.
                </p>
              ...
              <div className="flex flex-col items-center text-center group bg-white lg:bg-transparent p-6 lg:p-0 rounded-2xl shadow-sm lg:shadow-none border border-stone-100 lg:border-none">
                ...
                <p className="font-sans text-sm text-stone-600 leading-relaxed max-w-xs">
                  Pelatihan pencatatan pertumbuhan, deteksi dini kesehatan,
                  dan evaluasi berkala produktivitas ternak.
                </p>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        ...
        <div className="bg-amber-50 text-amber-900 p-6 md:p-8 rounded-2xl flex items-start gap-4 shadow-sm border border-amber-200/70">
          ...
          <div>
            ...
            <h4 className="font-sans font-bold text-lg text-amber-800 mb-1">
              Pemberitahuan Penting
            </h4>

            <p className="font-sans text-sm md:text-base text-amber-900/80 leading-relaxed">
              Kambing di Latar Bale digunakan sebagai pusat edukasi dan
              studi percontohan, bukan untuk diperjualbelikan. Program
              ini murni berfokus pada transfer pengetahuan dan

...
export default function Toko() {
  ...
  const [tokoWhatsapp, setTokoWhatsapp] = useState('6285808805840');
  ...
  // =========================================================
  // WHATSAPP
  // Semua tombol WhatsApp menggunakan nomor yang sama
  // =========================================================
  const tokoWhatsAppUrl = `https://wa.me/${tokoWhatsapp}`;

  const tokoWhatsAppMessage = encodeURIComponent(
    'Halo Admin Latar Balai, saya ingin memesan produk'
  );

  const tokoWhatsAppOrderUrl = `${tokoWhatsAppUrl}?text=${tokoWhatsAppMessage}`;
      ...
      <section className="w-full px-4 md:px-8 pt-8">
        <div className="relative h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden rounded-3xl">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('https://res.cloudinary.com/zqov2yh8/image/upload/v1785648297/Biru_dan_Coklat_Ilustrasi_Lomba_Mancing_Konten_Instagram_45_1_qprc0s.jpg')`,
            }}
          >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto px-4">
            ...
            <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl text-white font-bold mb-6 leading-tight">
              Toko Desa Mulyoarjo
              <br />
              <span className="font-sans font-light text-2xl md:text-4xl block mt-2 opacity-90">
          ...
          <aside className="w-full md:w-1/4 lg:w-1/5">
            ...
            <div className="sticky top-28">
              ...
              <nav className="hidden md:flex flex-col gap-2">
                ...
                {CATEGORIES.map((category) => (
                  <button
                    ...
                    className={`flex items-center px-4 py-3 rounded-xl font-sans font-semibold text-sm transition-all text-left cursor-pointer ${
              ...
              <div className="hidden md:block mt-12 p-6 bg-[#F4F1EA] rounded-2xl border border-stone-200">
                ...
                <h4 className="font-serif font-bold text-[#114224] mb-2">
                  Butuh Bantuan?
                </h4>
          ...
          <div className="w-full md:w-3/4 lg:w-4/5">
            ...
            <div className="flex md:hidden overflow-x-auto pb-4 mb-8 gap-2 scrollbar-none">
              ...
              {CATEGORIES.map((category) => (
                <button
                  key={category}
                  onClick={() => setActiveCategory(category)}
                  className={`whitespace-nowrap px-6 py-2 rounded-full font-sans font-bold text-sm transition-colors cursor-pointer ${
                    activeCategory === category
            ...
            {loading ? (
              <div className="py-20 text-center bg-[#F4F1EA] rounded-2xl border border-stone-200">
                ...
                <span className="material-symbols-outlined text-5xl text-stone-300 mb-4 block animate-pulse">
                  inventory_2
                </span>
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden bg-stone-100">
                      ...
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            'https://images.unsplash.com/photo-1542223175-7582dd7ee509?w=500&auto=format&fit=crop&q=60';
                        }}
                      />
                    ...
                    <div className="p-6 flex-grow flex flex-col">
                      ...
                      <div className="mt-auto pt-4 border-t border-stone-100 flex items-center justify-between">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="font-sans text-[11px] text-stone-400 uppercase tracking-wider">
                            Harga
                          </span>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 text-[#114224]">
            ...
            {[
              ...
              {
                icon: 'payments',
                label: 'Harga Fair Trade',
              },
            ].map((item) => (

              <div
                key={item.icon}
                className="flex items-center gap-3 bg-white px-5 py-3 rounded-xl border border-stone-200/60 shadow-sm"
              >

                <div className="w-10 h-10 rounded-full bg-[#114224]/10 flex items-center justify-center">

                  <span className="material-symbols-outlined text-xl text-[#114224]">
                    {item.icon}
                  </span>

                </div>

                <span className="font-sans font-bold text-sm tracking-wide text-[#191C19]">
                  {item.label}
                </span>
